...
extern "C" 
Handle<Value> CascadeClassifierWrap::New(const Arguments &args) {
  HandleScope scope;
...
extern "C" 
Handle<Value> CascadeClassifierWrap::DetectMultiScale(const v8::Arguments& args){
  HandleScope scope;
...
extern "C" 
void CascadeClassifierWrap::AsyncDetectMultiScale(uv_work_t *req) {
...
extern "C" 
void CascadeClassifierWrap::AfterAsyncDetectMultiScale(uv_work_t *req) {
