...
module.exports.sockets = {
  ...
  onConnect: function(session, socket) {
    ...
    socket.on('register-image', function(data) {
      console.log('register-image');
      socket.name = data.name;
      socket.images = socket.images || [];
      socket.images.push(data.image);
    });

    socket.on('register-end', function(data) {
      console.log('register-end');
      // array of 10 base64 image data
      var name = socket.name;
      var images_data = socket.images;
